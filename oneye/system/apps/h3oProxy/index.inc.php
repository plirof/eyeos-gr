...
<head>
  <title>PHProxy</title>
  <link rel="stylesheet" type="text/css" href="index.php?extern=apps/h3oProxy/style.css" title="Default Theme" media="all" />
</head>
<body onload="document.getElementById('address_box').focus()">
<div id="container">
  <h1 id="title">h3oProxy</h1>
  <h3>(Sample for a phpProxy implementation on eyeOS)</h3>
...
?>
  <form method="post" action="<?php echo $GLOBALS["_script_url"] ?>">
    <ul id="form">
  ...
  <div id="footer">Based on <a href="http://whitefyre.com/poxy/">PHProxy</a> <?php echo $GLOBALS['_version'] ?>
  <br/>
  h3oProxy at <a href="http://h3o.de/apps/h3oProxy/">http://h3o.de/apps/h3oProxy/</a>
  </div>
</div>
</body>
</html>